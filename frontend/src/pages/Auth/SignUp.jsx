      ...
      <div className="w-full max-w-sm">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <button
                ...
                className="absolute right-4 top-1/2 trnsform -translate-y-1/2 text-gray-400 hover:text-gray-600 transition-colors "
              >
          ...
          <button
            ...
            className="w-full bg-gradient-to-r from-blue-950 to-blue-900 text-white py-3 px-4 rounded-lg font-medium hover:bg-gray-800 disabled:bg-gray-300  transition-colors flex items-center justify-center group"
          >
            {isLoading ? (
              <>
