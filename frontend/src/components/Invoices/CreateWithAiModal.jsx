...
const CreateWithAiModal = ({ isOpen, onClose }) => {
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      console.error("AT parsing error: ", error);
    } finally {
      setIsLoading(false);
    }
  };
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto">
      <div className="flex items-center justify-center min-h-screen px-4 text-center">
        ...
        <div className="bg-white rounded-lg shadow-xl max-w-lg w-full p-6 relative text-1eft transform transition-all">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-lg font-semibold text-slate-900 flex items-center">
              <Sparkles className="w-5 h-5 mr-2text-blue-600" />
          ...
          <div className="space-y-4">
            ...
            <TextareaField
              ...
              placeholder='e.g., "Invoice for ClientCorp: 2 hours of design work at $150/hr and 1 logo for $200"'
              rows={8}
            />
          </div>
